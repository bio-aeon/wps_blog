...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post._text_rendered'
        db.add_column(u'blog_post', '_text_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Post.text'
        db.alter_column(u'blog_post', 'text', self.gf('markitup.fields.MarkupField')(no_rendered_field=True))
    ...
    models = {
        ...
        'blog.comment': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['blog.Comment']"}),
        ...
        'blog.commentrate': {
            'Meta': {'object_name': 'CommentRate', 'db_table': "'blog_comment_rate'"},
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Comment']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
