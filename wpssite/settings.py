...
DATABASES = {
    'default': {
        ...
        'NAME': 'wpssite_db',                      # Or path to database file if using sqlite3.
...
if DEBUG:
    ...
    DATABASES['default']['PASSWORD'] = 'm38o6dEn'
...
SECRET_KEY = 'xb&amp;&amp;h0yc(4$*n(ul@ysphcy)(mvjq7c5iigt1r2@b0*3asd)-l'
